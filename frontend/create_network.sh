...
# LAN
sudo ip netns exec ns1 tc qdisc add dev veth1 root netem delay 0.2ms rate 10gbit
# WAN
#sudo ip netns exec ns1 tc qdisc add dev veth1 root netem delay 70ms rate 100mbit
